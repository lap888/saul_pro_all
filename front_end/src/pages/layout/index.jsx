...
import { lTitle } from '../../utils/constants'
...
function LayoutConfig() {
  ...
  return (
    <Layout className={styles.layout}>
      {/* 侧边栏适配移动端 */}
      {width < 650 ? (
        <Drawer placement="left" width="50%" visible={visible} onClose={onClose} closable={false} bodyStyle={{ padding: 0 }}>
      ...
      <Layout className={styles['site-layout']}>
        ...
        >
          <p style={styles.desc}>Author & WeChat QQ ©{(new Date().getFullYear())}</p>
        </Footer> */}
      </Layout>
    </Layout>
  );
