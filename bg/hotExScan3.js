 ...
 * @Last Modified time: 2023-02-24 23:50:18
 */
...
let btRate = { 'ETHUSDT': 2.8, 'BTCUSDT': 30 }
            ...
            if (twoSymbolData[symbol].t == null || Date.now() - twoSymbolData[symbol].t <= interValTime * 1000) {
                            ...
                            if (isClose[`${v.name}_${symbol}`] == 1) {
                                if (symbolAction[`${symbol}`].action == 'S') {
                                    if (bgP[symbol] > symbolAction[`${symbol}`].price + btPrice3) {
                                        ...
                                        } else if (threeSymbolData[symbol].min < symbolAction[`${symbol}`].price - oneP * 11 && bgP[symbol] > symbolAction[`${symbol}`].price - oneP * 10) {
                                            sDt2[`${symbol}`] = -1;
                                            SellClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                        ...
                                        } else if (threeSymbolData[symbol].min < symbolAction[`${symbol}`].price - oneP * 10 && bgP[symbol] > symbolAction[`${symbol}`].price - oneP * 9) {
                                            sDt2[`${symbol}`] = -1;
                                            SellClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                        ...
                                        } else if (threeSymbolData[symbol].min < symbolAction[`${symbol}`].price - oneP * 8 && bgP[symbol] > symbolAction[`${symbol}`].price - oneP * 7) {
                                            sDt2[`${symbol}`] = -1;
                                            SellClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                        ...
                                        } else if (threeSymbolData[symbol].min < symbolAction[`${symbol}`].price - oneP * 4.5 && bgP[symbol] > symbolAction[`${symbol}`].price - oneP * 3.5) {
                                            sDt2[`${symbol}`] = -1;
                                            SellClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                ...
                                if (symbolAction[`${symbol}`].action == 'L') {
                                    if (bgP[symbol] < symbolAction[`${symbol}`].price - btPrice3) {
                                        ...
                                        } else if (threeSymbolData[symbol].max > symbolAction[`${symbol}`].price + oneP * 11 && bgP[symbol] < symbolAction[`${symbol}`].price + oneP * 10) {
                                            sDt2[`${symbol}`] = -1;
                                            BuyClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                        ...
                                        } else if (threeSymbolData[symbol].max > symbolAction[`${symbol}`].price + oneP * 10 && bgP[symbol] < symbolAction[`${symbol}`].price + oneP * 9) {
                                            sDt2[`${symbol}`] = -1;
                                            BuyClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                        ...
                                        } else if (threeSymbolData[symbol].max > symbolAction[`${symbol}`].price + oneP * 8 && bgP[symbol] < symbolAction[`${symbol}`].price + oneP * 7) {
                                            sDt2[`${symbol}`] = -1;
                                            BuyClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                                        ...
                                        } else if (threeSymbolData[symbol].max > symbolAction[`${symbol}`].price + oneP * 4 && bgP[symbol] < symbolAction[`${symbol}`].price + oneP * 3.5) {
                                            sDt2[`${symbol}`] = -1;
                                            BuyClose(symbol, amount, v.rToken).then(res => {
                                                if (res != '' && res.code == 200) {
                ...
                if (diffPrice > btPrice1 && ms <= interValTime * 1000 + 10) {
                    if ((sDt[`${symbol}`] == undefined || Date.now() - sDt[`${symbol}`] > sDtTime * 1000) && (sDt2[`${symbol}`] == undefined || sDt2[`${symbol}`] == -1)) {
                        ...
                        symbolAction[`${symbol}`] = { symbol: symbol, action: flag, price: (Number(price) + bgP[symbol]) / 2, hotPrice: bgP[symbol], time: new Date().getTime(), flag: -1, rToken: '', btSession: '', btNewSession: '' };
                        sDt3[symbol] = Date.now();
