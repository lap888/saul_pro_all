 ...
 * @Last Modified time: 2023-06-19 11:38:22
 */
                            ...
                            if (symbol == curSymbol) {
                                ...
                                if (longPos.length > 0 && longPos[0].pa != 0 && (Date.now() - OpenForderDate[symbol] > 500 || OpenForderDate[symbol] == undefined)) {
                                    ...
                                    if (longPos[0].pp < vInfo.totalAmount) {
                                        //顺势追 逆势加 回调0.1%止盈
                                        if (ma90m1[symbol] == 'L' && sarm1[symbol] == 'L') {
                                    ...
                                    //回调止盈 且 覆盖手续费 
                                    if (longPos[0].pa > 0 && longPos[0].up > 0 && sarm1[symbol] == 'L' && vInfo.lRightAddCount > 4) {
                                        //
                                        if (longPos[0].up > longPos[0].pa * longPos[0].ep * 0.1 && longPos[0].up < lIncomeMax[symbol] * 0.5 && (Date.now() - OpenOrderDate0[symbol] > nextOrderWait || OpenOrderDate0[symbol] == undefined)) {
                                            OpenOrderDate0[symbol] = Date.now()
                                ...
                                if (shortPos.length > 0 && shortPos[0].pa != 0 && (Date.now() - OpenForderDate[symbol] > 500 || OpenForderDate[symbol] == undefined)) {
                                    ...
                                    if (shortPos[0].pp < vInfo.totalAmount) {
                                        //顺势追 逆势加 回调0.1%止盈
                                        if (ma90m1[symbol] == 'S' && sarm1[symbol] == 'S') {
                                    ...
                                    if (shortPos[0].pa > 0 && shortPos[0].up > 0 && sarm1[symbol] == 'S' && vInfo.sRightAddCount > 4) {
                                        if (shortPos[0].up > shortPos[0].pa * shortPos[0].ep * 0.1 && shortPos[0].up < sIncomeMax[symbol] * 0.5 && (Date.now() - OpenOrderDate1[symbol] > nextOrderWait || OpenOrderDate1[symbol] == undefined)) {
                                            OpenOrderDate1[symbol] = Date.now()
