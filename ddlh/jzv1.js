 ...
 * @Last Modified time: 2023-05-28 11:01:52
 */
...
let symbolSetting = {
    'BNBUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 2, 'action': 'N', 'amount': 0, 'doAmount': 20, 'isSet': 0 },
    'KEYUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 2, 'action': 'N', 'amount': 0, 'doAmount': 100, 'isSet': 0 },
}
...
function calNotice(symbol) {
    ...
    caltime.map(t => {
        ...
        //     // 短期内波动
        //     // {
        //     //     if ((allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) > rPrice[symbol] * 0.01) {
        //     //         if (zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-001`] == undefined) {
        //     //             zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-001`] = '001'
        //     //             pLog(`波动预警通知:${symbol}-${t}-内波动超过1%,达到:${(allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) / rPrice[symbol]}`)
        //     //         }
        //     //     }
        //     //     if ((allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) > rPrice[symbol] * 0.02) {
        //     //         if (zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-002`] == undefined) {
        //     //             zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-002`] = '002'
        //     //             pLog(`波动预警通知:${symbol}-${t}-内波动超过2%,达到:${(allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) / rPrice[symbol]}`)
        //     //         }
        //     //     }
        //     //     if ((allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) > rPrice[symbol] * 0.03) {
        //     //         if (zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-003`] == undefined) {
        //     //             zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-003`] = '003'
        //     //             pLog(`波动预警通知:${symbol}-${t}-内波动超过3%,达到:${(allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) / rPrice[symbol]}`)
        //     //         }
        //     //     }
        //     //     if ((allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) > rPrice[symbol] * 0.04) {
        //     //         if (zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-004`] == undefined) {
        //     //             zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-004`] = '004'
        //     //             pLog(`波动预警通知:${symbol}-${t}-内波动超过4%,达到:${(allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) / rPrice[symbol]}`)
        //     //         }
        //     //     }
        //     //     if ((allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) > rPrice[symbol] * 0.05) {
        //     //         if (zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-005`] == undefined) {
        //     //             zfRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-005`] = '005'
        //     //             pLog(`波动预警通知:${symbol}-${t}-内波动超过5%,达到:${(allCoinNotice[symbol][t]['max'] - allCoinNotice[symbol][t]['min']) / rPrice[symbol]}`)
        //     //         }
        //     //     }
        //     // }
        //     // 黄金分割
        ...
        //     //             if (hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-236`] == undefined) {
        //     //                 hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-236`] = '236'
        //     //                 pLog(`黄金分隔:${symbol}-${t}-内,触及黄金分割|0.236,达到:${allCoinNotice[symbol][t]['rate']}`)
        //     //             }
        //     //         }
        //     //         if (allCoinNotice[symbol][t]['rate'] > 0.382) {
        //     //             if (hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-382`] == undefined) {
        //     //                 hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-382`] = '382'
        //     //                 pLog(`黄金分隔:${symbol}-${t}-内,触及黄金分割|0.382,达到:${allCoinNotice[symbol][t]['rate']}`)
        //     //             }
        //     //         }
        //     //         if (allCoinNotice[symbol][t]['rate'] > 0.5) {
        //     //             if (hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-05`] == undefined) {
        //     //                 hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-05`] = '05'
        //     //                 pLog(`黄金分隔:${symbol}-${t}-内,触及黄金分割|0.50,达到:${allCoinNotice[symbol][t]['rate']}`)
        //     //             }
        //     //         }
        //     //         if (allCoinNotice[symbol][t]['rate'] > 0.618) {
        //     //             if (hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-618`] == undefined) {
        //     //                 hjRate[`${symbol}-${allCoinNotice[symbol][t]['time']}-618`] = '618'
        //     //                 pLog(`黄金分隔:${symbol}-${t}-内,触及黄金分割|0.618,达到:${allCoinNotice[symbol][t]['rate']}`)
        //     //             }
        //     //         }
        //     //     }
        //     // }
            ...
            client.listenKeyPost().then(async response => {
                ...
                for (let i = 0; i < symbolDatas.length; i++) {
                    client.records(symbolDatas[i], '5m', 500).then(k => {
                        ...
                        symbolSetting[`${symbolDatas[i]}`]['osc'] = _N(total / k.length, 6) * 1.1
                    }).catch(err => {
                ...
                client.combinedStreams(SymbolDataArrys, {
                    ...
                    message: (msg) => {
                        ...
                        if (dt[`${symbol}`] == undefined || Date.now() - dt[`${symbol}`] >= 0) {
                            ...
                            let d5 = new Date(d1.getFullYear(), d1.getMonth(), d1.getDate(), d1.getHours(), d1.getMinutes(), d1.getSeconds() + 1)
