 ...
 * @Last Modified time: 2023-05-27 12:04:35
 */
...
let symbolSetting = {
    'BNBUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 1, 'action': 'N', 'amount': 0, 'doAmount': 20, 'isSet': 0 },
    'BTCUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 1, 'action': 'N', 'amount': 0, 'doAmount': 20, 'isSet': 0 },
    'ETHUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 1, 'action': 'N', 'amount': 0, 'doAmount': 20, 'isSet': 0 },
    'TOMOUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 1, 'action': 'N', 'amount': 0, 'doAmount': 20, 'isSet': 0 },
    'INJUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 1, 'action': 'N', 'amount': 0, 'doAmount': 20, 'isSet': 0 },
    'KEYUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 2, 'action': 'N', 'amount': 0, 'doAmount': 100, 'isSet': 0 },
    'AGIXUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 2, 'action': 'N', 'amount': 0, 'doAmount': 100, 'isSet': 0 },
    'MTLUSDT': { 'rate': 0.62, 'osc': 0, 'doType': 2, 'action': 'N', 'amount': 0, 'doAmount': 100, 'isSet': 0 },
                    ...
                    message: (msg) => {
                        ...
                        if (sDt2[`${symbol}`] != -1 && sDt2[`${symbol}`] != undefined && Date.now() - sDt[`${symbol}`] > 1 * 20 && Date.now() > symbolAction[`${symbol}`].cancloseTime) {
                            if (symbolAction[`${symbol}`].action == 'S' && errorCountS[symbol] <= 5) {
                                ...
                                // if (rPrice[symbol] < symbolAction[`${symbol}`].price - symbolSetting[`${symbol}`]['osc'] * 0.8 && rPrice[symbol] < symbolAction[`${symbol}`].price * (1 - 0.01 * 0.08)) {
