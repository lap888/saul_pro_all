 ...
 * @Last Modified time: 2023-04-20 11:38:59
 */
                            ...
                            if (lockSymbol == symbol) {
                                ...
                                if (longPos.length > 0) {
                                    ...
                                    if (lIncome + vInfoUnlock.gIncome > mIncome && lIncome < lIncomeMax[symbol] * 0.9) {
                                        ...
                                        //更新数据库
                                        let sql2 = 'update `ddlh_coin` set lPrice=?,unLockCount=unLockCount+0.53,gIncome=0,gCount=0,unLockIncome=unLockIncome+?,totalIncome=totalIncome+?,lockStatus=0,utime=now() where id=?'
                                ...
                                if (shortPos.length > 0) {
                                    ...
                                    if (sIncome + vInfoUnlock.gIncome > mIncome && sIncome < sIncomeMax[symbol] * 0.9) {
                                        ...
                                        //更新数据库
                                        let sql2 = 'update `ddlh_coin` set sPrice=?,unLockCount=unLockCount+0.53,gIncome=0,gCount=0,unLockIncome=unLockIncome+?,totalIncome=totalIncome+?,lockStatus=0,utime=now() where id=?'
