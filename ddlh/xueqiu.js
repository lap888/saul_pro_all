 ...
 * @Last Modified time: 2023-08-19 15:14:18
 */
                                ...
                                if (longPos.length > 0 && longPos[0].pa != 0 && (Date.now() - OpenForderDate[symbol] > nextOrderWait || OpenForderDate[symbol] == undefined)) {
                                    ...
                                    if (longPos[0].pp < vInfo.totalAmount) {
                                        ...
                                        if (vInfo.lRightAddCount < vInfo.rightAddMax) {
                                            ...
                                            if ((longPos[0].up - vInfo.lIncome > vInfo.rightPpAmount / vInfo.level - 1) && longPos[0].up > 0 && (Date.now() - OpenOrderDate0[symbol] > nextOrderWait || OpenOrderDate0[symbol] == undefined)) {
                                                        ...
                                                        if (pos_hy_l.length > 0) {
                                                            pos_hy_l.map(v => {
                                                                client.calAllOrder(symbol, { orderId: v.orderId.toString() }).then(res => {
                                                                    ...
                                                                    if (longPos[0].up > 1.5 * vInfo.rightPpAmount) {
                                    ...
                                    if ((OpenForderDate[symbol] == undefined || Date.now() - OpenForderDate[symbol] > 1000 * 15 * 60) && (longPos.length <= 0 || (longPos.length > 0 && longPos[0].pa == 0))) {
                                        let ot = new Date(vInfo.dtime).getTime()
                                        let nt = new Date().getTime()
                                        if (vInfo.action == 'L' && nt > ot) {
                                ...
                                if (shortPos.length > 0 && shortPos[0].pa != 0 && (Date.now() - OpenForderDate[symbol] > nextOrderWait || OpenForderDate[symbol] == undefined)) {
                                    ...
                                    if (shortPos[0].pp < vInfo.totalAmount) {
                                        ...
                                        if (vInfo.sRightAddCount < vInfo.rightAddMax) {
                                            ...
                                            if ((shortPos[0].up - vInfo.sIncome > vInfo.rightPpAmount / vInfo.level - 1) && shortPos[0].up > 0 && (Date.now() - OpenOrderDate1[symbol] > nextOrderWait || OpenOrderDate1[symbol] == undefined)) {
                                                        ...
                                                        if (pos_hy_s.length > 0) {
                                                            pos_hy_s.map(v => {
                                                                client.calAllOrder(symbol, { orderId: v.orderId.toString() }).then(res => {
                                                                    ...
                                                                    // TAKE_PROFIT_MARKET
                                                                    if (shortPos[0].up > 1.5 * vInfo.rightPpAmount) {
                                    ...
                                    //止盈 且 覆盖手续费 
                                    if (shortPos[0].pa > 0 && shortPos[0].up > vInfo.level * vInfo.lossAmount && (Date.now() - OpenOrderDate0[symbol] > 1.5 * 1000 || OpenOrderDate1[symbol] == undefined)) {
                                        OpenOrderDate1[symbol] = Date.now()
